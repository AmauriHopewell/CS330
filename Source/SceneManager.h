...
private:
	...
	void SetupSceneLights();
	 ...
	 //custom funciton to generate complex shape at desired point
	void DrawClock(glm::vec3 groupPos, glm::vec3 groupScale, float groupRotX, float groupRotY, float groupRotZ);
